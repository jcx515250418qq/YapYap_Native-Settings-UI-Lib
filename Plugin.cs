...
{
    [BepInPlugin("com.yapyap.nativesettingsui", "Yap Native Settings UI", "1.0.1")]
    ...
    public static class NativeSettingsUI
    {
        ...
        internal static void Inject(UISettings uiSettings, bool isInGame)
        {
            ...
            Transform content = ResolveContentRoot(uiSettings);
            if (content == null)
            {
                return;
            }
        ...
        private static Transform ResolveContentRoot(UISettings uiSettings)
        {
            if (uiSettings == null)
            {
                return null;
            ...
            content = uiSettings.transform.Find("UISettings/Window/Content");
            if (content != null)
            {
                return content;
            }

            Transform root = uiSettings.transform.root;
            if (root == null)
            {
                return null;
            }

            content = root.Find("Canvas_Menu/UISettings/Window/Content");
            if (content != null)
            {
                return content;
            }
            ...
            content = root.Find("Canvas/Menu/Settings/UISettings/Window/Content");
            return content;
        }
    ...
    internal readonly struct Templates
    {
        ...
        public static bool TryResolve(Transform content, out Templates templates)
        {
            ...
            if (uiRoot != null)
            {
                ...
                if (closeButton == null)
                {
                    closeButton = uiRoot.Find("Canvas_Menu/UISettings/Window/Content/ButtonContainer/Close");
                }
                if (closeButton == null)
                {
                    closeButton = uiRoot.Find("Canvas/InGameMenu/Settings/UISettings/Window/Content/ButtonContainer/Close");
                }
                if (closeButton == null)
                {
                    closeButton = uiRoot.Find("Canvas/Menu/Settings/UISettings/Window/Content/ButtonContainer/Close");
                }
            }
